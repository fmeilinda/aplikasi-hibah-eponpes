                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                          ...
                          <input class="form-control" id="nomor_surat" type="text" name="nomor_surat" placeholder="Masukkan Nomor Surat" required oninvalid="this.setCustomValidity('Nomor Surat Wajib Diisi')"
                          oninput="this.setCustomValidity('')">
                        </div>

                        <div class="form-group">
                            <label for="tgl_surat"> Tanggal Surat </label><br>
                            <input class="form-control" id="tgl_surat" type="date" name="tgl_surat" placeholder="Masukkan Tanggal Surat" required oninvalid="this.setCustomValidity('Tanggal Surat Wajib Diisi')"
                            oninput="this.setCustomValidity('')">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="penerima" type="text" name="penerima" placeholder="Masukkan Nama Penerima" required oninvalid="this.setCustomValidity('Nama Penerima Wajib Diisi')"
                                oninput="this.setCustomValidity('')">
                              </div>
