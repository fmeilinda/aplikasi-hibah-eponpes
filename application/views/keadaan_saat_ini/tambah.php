            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <?php endif; ?>
                      <form action="<?=base_url('keadaan_saat_ini/save');?>" method="post" enctype="multipart/form-data">


                        <div class="form-group">
                          <label for="keadaan">Keadaan Saat Ini</label><br>
                          <input class="form-control" id="keadaan" type="text" name="keadaan" placeholder="Masukkan Keadaan Saat ini" required oninvalid="this.setCustomValidity('Jenis Masalah Wajib Diisi')"
