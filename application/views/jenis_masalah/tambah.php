            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <?php endif; ?>
                      <form action="<?=base_url('jenis_masalah/save');?>" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                          <label for="jenis_masalah">Jenis Masalah</label><br>
                          <input class="form-control" id="jenis_masalah" type="text" name="jenis_masalah" placeholder="Masukkan Jenis Masalah" required oninvalid="this.setCustomValidity('Jenis Masalah Wajib Diisi')"
