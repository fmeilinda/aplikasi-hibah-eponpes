                    ...
                    <div class="card-body">
                      ...
                      <form action="<?=base_url('jenis_masalah/update/'.$row['id_jenis_masalah']);?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" id="jenis_masalah" type="text" name="jenis_masalah" value="<?=$row['jenis_masalah']?>" required oninvalid="this.setCustomValidity('Jenis Masalah Wajib Diisi')"
